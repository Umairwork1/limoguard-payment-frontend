...
type DirectTab = 'session' | 'customers' | 'charge' | 'initiate' | 'register' | 'detail';
...
// Ordered to mirror the v3 vendor-managed recurring flow
...
export default function App() {
  ...
  // Sidebar click → Token Detail
  const handleTokenSelect = (tokenId: string) => {
    setActiveTokenId(tokenId);
    setDirectTab('detail');
  };
  // CustomerCards "Charge →" → pre-fill Charge Token tab
